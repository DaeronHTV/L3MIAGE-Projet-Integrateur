...
// Généré le : 2020.04.10 à 11:33:55 AM CEST 
//


package l3m.LesClients.java;
 ...
 *         &lt;element name="email" type="{http://u-ga.fr/site}Email"/>
 *         &lt;element name="tel" type="{http://u-ga.fr/site}Telephone"/>
...
public class Client {
    ...
    public String toString() {
        return "id :" + id + " | " + "nom :" + nom + " | " + "prenom :" + prenom + " | " + 
                "photo :" + photo + " | " + "email :" + email + " | " + "tel :" + tel + " | " + "adresse :" + adresse;
    }   
